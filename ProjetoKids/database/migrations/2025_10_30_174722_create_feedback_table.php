...
class AddFeedbackColumnsToFeedbackTable extends Migration
{
    public function up()
    {
    ...
    public function down()
    {
        Schema::table('feedback', function (Blueprint $table) {
            if (Schema::hasColumn('feedback', 'user_id')) {
                $table->dropForeign([$table->getConnection()->getDoctrineSchemaManager()->listTableDetails($table->getTable())->hasColumn('user_id') ? 'user_id' : null]);
